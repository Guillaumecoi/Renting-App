...
mkdir -p ../src/main/java/coigniez/rentapp/model/$ENTITY
mkdir -p ../src/test/java/coigniez/rentapp/model/$ENTITY
...
echo "$ENTITY_TEMPLATE" > ../src/main/java/coigniez/rentapp/model/$ENTITY/$ENTITY.java

# Create Repository
REPOSITORY_TEMPLATE=$(cat templates/repository.txt)
REPOSITORY_TEMPLATE=${REPOSITORY_TEMPLATE//\$ENTITY/$ENTITY}
echo "$REPOSITORY_TEMPLATE" > ../src/main/java/coigniez/rentapp/model/$ENTITY/${ENTITY}Repository.java
...
echo "$SERVICE_TEMPLATE" > ../src/main/java/coigniez/rentapp/model/$ENTITY/${ENTITY}Service.java
...
echo "$ENTITY_TEST_TEMPLATE" > ../src/test/java/coigniez/rentapp/model/$ENTITY/${ENTITY}Test.java
...
echo "$REPOSITORY_TEST_TEMPLATE" > ../src/test/java/coigniez/rentapp/model/$ENTITY/${ENTITY}RepositoryTest.java
...
echo "$SERVICE_TEST_TEMPLATE" > ../src/test/java/coigniez/rentapp/model/$ENTITY/${ENTITY}ServiceTest.java